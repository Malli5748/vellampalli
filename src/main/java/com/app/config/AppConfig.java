...
public class AppConfig{
	...
	/*
	 * @Autowired private UserIdToObjectConverter userConverter;
	 */
	...
	public LocalSessionFactoryBean sfObj() {
		...
		sf.setAnnotatedClasses(UserPeople.class,Document.class);
 ...
 * registry.addConverter(userConverter); } //5. Password Encoder
 * 
